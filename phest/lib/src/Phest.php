...
class Phest {
    ...
    protected $subsection_data = array();
    protected $site = '';
    protected $lang = '';
    protected $buildtype = '';
     ...
     * @chainable
     */
    public function add($section,$message_or_subsection,$message = ''){
        ...
        if ($message){
            $this->message_data[$section]['sublist'][$message_or_subsection][] = $message;
        }else{
            $this->message_data[$section]['list'][] = $message_or_subsection;
        }
    ...
    public function getMessageData(){
        ...
        foreach ($type_list as $type){
            foreach ($this->message_data as $section => $mdat){
                ...
                if (isset($mdat['subsection'])){
                    $mdat['subsection_list'] = array_keys($mdat['subsection']);
                }
                ...
                if (isset($mdat['sublist']) and count($mdat['sublist'])){
                    $is_show = true;
                    foreach ($mdat['sublist'] as $subsection => $list){
                        if (!empty($mdat['sort'])){
                            sort($mdat['sublist'][$subsection]);
                        }
                    }
                }
